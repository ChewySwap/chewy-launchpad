...
const StakingChart = ({ data, setValue, setLabel }: LineChartProps) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col content-center items-center self-center w-full h-full z-0">
        <div className="flex w-full h-full z-0" ref={chartRef} />
      </div>
    </>
  )
}
